// this example source code found here: http://stackoverflow.com/questions/5317261/using-ptrace-to-track-all-execve-calls-across-children
// credit to stackoverflow "Clint O"
